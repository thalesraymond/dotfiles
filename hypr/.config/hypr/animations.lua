...
hl.curve("snappyVert", { type = "bezier", points = { { 0.4, 0 }, { 0.2, 1 } } })
...
-- hl.animation({ leaf = "borderangle",  enabled = true, speed = 180, bezier = "liner", style = "loop" }) -- rainbow borders
